        ...
        >
            <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <a href="https://dynamicnotchofficial.lemonsqueezy.com/checkout/buy/b1976809-d837-4608-acb1-7de6e790ae43" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white text-white hover:text-black text-sm font-medium px-4 py-1.5 rounded-full transition-all duration-300 border border-white/10 shadow-sm hover:shadow-lg hover:shadow-white/20 inline-flex items-center justify-center relative z-50">
                        Purchase
                    </a>
                </div>
            </div>
